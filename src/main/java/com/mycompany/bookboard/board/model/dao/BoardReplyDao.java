package com.mycompany.bookboard.board.model.dao;
...
public class BoardReplyDao {
	...
	public List<com.mycompany.bookboard.board.model.vo.BoardReply> selectList(String board_num) { // 게시글에 해당하는 댓글 조회
	...
	public int updateBoardReply(BoardReply br) { // 댓글 수정
